...
import com.poletaiev.security.sec.JwtTokenProvider;
...
public class AuthRestController {
    ...
    public ResponseEntity<?> authenticate(@RequestBody AuthRequestDTO request) {
        try {
            ...
            User user = userRepository.findUserByEmail(request.getEmail()).orElseThrow(() -> new UsernameNotFoundException("User "+ request.getEmail() + " does not exist!"));
